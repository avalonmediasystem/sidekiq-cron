...
Gem::Specification.new do |s|
  ...
  s.homepage = "http://github.com/avalonmediasystem/sidekiq-cron".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "3.1.2".freeze
  s.summary = "Sidekiq Cron helps to add repeated scheduled jobs (Avalon fork)".freeze
